...
CREATE TABLE invoice( id INTEGER NOT NULL AUTO_INCREMENT, customer_full_name VARCHAR(50),phone_number VARCHAR(20),invoice_date VARCHAR(50),number_of_items int,total_amount int,
